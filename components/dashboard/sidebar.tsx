...
const items = [
  ...
  { href: "/experiences", label: "Experiencias", icon: Map },
  { href: "/leads", label: "Leads", icon: MessageSquare },
  { href: "/subscriptions/expiring", label: "Por vencer", icon: AlarmClock },
  ...
  return (
    <aside className="bg-sidebar text-sidebar-foreground border-sidebar-border hidden w-60 shrink-0 border-r md:flex md:flex-col">
      ...
      <div className="border-sidebar-border border-t p-3">
        <p className="text-sidebar-foreground/50 text-xs">Panel admin · v1</p>
      </div>
    </aside>
  )
}
